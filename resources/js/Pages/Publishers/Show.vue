...
const hasBooks = computed(() => (props.publisher.books?.length ?? 0) > 0)

const deleteMessage = computed(() => {
    return `This action cannot be undone. "${props.publisher.name}" will be permanently deleted.`
})
...
const destroyPublisher = () => {
    router.delete(route("publishers.destroy", props.publisher.id), {
        onFinish: () => closeDelete(),
    })
}

const logoUrl = computed(() =>
    props.publisher.logo ? props.publisher.logo : "/images/publisher-placeholder.png"
)
...
<template>
    <public-layout :title="publisher.name">
        <div class="p-6 max-w-6xl mx-auto space-y-6">
            <div class="flex items-center gap-6 bg-gray-800 p-6 rounded-lg">
                ...
                <div class="flex-1">
                    ...
                    <p class="opacity-70 mt-1">
                        {{ publisher.books.length }} published books
                    </p>
                </div>
            ...
            <div class="bg-gray-800 p-6 rounded-lg">
                ...
                <div v-if="publisher.books.length === 0" class="opacity-60">
                    No books registered for this publisher.
                </div>
